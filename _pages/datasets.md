...
常用的退化数据与可靠性分析数据集，包含数据说明、数据出处与下载链接。详细介绍见推文 [(1)](https://mp.weixin.qq.com/s/DRcW3D7lfKPxWv7I19e0Yg)。
...
> 数据出处: Xu, A., Wang, B., Zhu, D., Pang, J., & Lian, X. (2025). Bayesian reliability assessment of permanent magnet brake under small sample size. *IEEE Transactions on Reliability, 74*(1), 2107-2117.
